    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white max-w-4xl mx-auto px-4">
          ...
          >
            Romantic <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-500 block">Getaways</span>
          </motion.h1>
          <motion.p 
            initial={{opacity: 0,y: 30}} 
            animate={{opacity: 1,y: 0}} 
          ...
          >
            Intimate escapes crafted for couples seeking extraordinary moments together. Where love stories unfold in the world's most enchanting destinations.
          </motion.p>
          <motion.div 
            initial={{opacity: 0,y: 30}} 
            animate={{opacity: 1,y: 0}} 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              You want to create magical moments with your partner,not stress about planning every detail. Let us handle the logistics while you focus on love.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Every romantic getaway is thoughtfully designed to deepen your connection and create unforgettable shared experiences.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              From sunrise to starlight,we create opportunities for romance at every turn of your journey.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Hand-selected destinations that provide the perfect backdrop for your love story to unfold.
            </motion.p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <blockquote className="text-xl text-gray-700 mb-6 italic leading-relaxed">
              "Our romantic getaway to Santorini was absolutely magical. Every detail was perfect - from the private sunset dinner to the surprise couples' massage. SeetaLuxuryEscape didn't just plan a trip;they created memories that will last a lifetime. This is how romance should be done!"
            </blockquote>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500 to-rose-500">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            Let us craft the perfect romantic escape where every moment deepens your connection. Your extraordinary love story begins with a single conversation.
          </motion.p>
          <motion.div 
            initial={{opacity: 0,y: 30}} 
            whileInView={{opacity: 1,y: 0}} 
